...
󾝼󾚜󾚜񽽼󾚜򚚜򚚜󾚜򚝼ᡠ񺝠򚚜򚚜󾚜󾚜򚚜򚚜󾚜󾚜򚚜򚚜󾚜󾚜򚚜򚚜󾚜󾚜򚚜򚚜󾚜󾚜򚚜򚚜򚚜󾚜󾚜󾚜󾚜󾚜󾚜󾚜򚚜󾚜 
UART_115200
...
[    0.000251] [AT][KR][reset timer][2466]
[    0.539892] zram: [ZSM] ZRAM compiled with ZSM, and zsm_on=1.
[    0.545683] zram: [ZSM] Turn on ZSM by $echo 1 > /sys/block/zram0/zsm_on before change the ZRAM disksize.
[    0.555267] zram: [ZSM] Check ZSM on/off by $cat /sys/block/zram0/zsm_on
 [RAMLOG] tee_entry_get_ramlog_config 624 

 [ramlog] tee_get_ramlog_config 432 

[    0.612842] ==RTC== MDrv_RTC_Init, 86
[    0.646244] [_MDrv_GFLIPIO_ModuleInit,1540][pid:1][name:swapper/0]_devGFLIP.refCnt=0
[    0.931614] Waiting for MMC done ...
[    0.935222] [AT][KR][start init][3401]
[    0.939669] [AutoTest][Kernel][start Initprocess][3401]
console:/ $  [ramlog] tee_get_ramlog_config 432 

[ramlog] Chip ID: da 64 0e 65 b2 fb 94 ed

[    3.053544] [ALG_3pty][_MDrv_HDR10PLUS_ModuleInit] u32Version= 0x20300
[    3.365438] [MDLA][COMM] MDLA: MDLARegisterToUtopia
[    3.370943] [MDLA][COMM] -
[    3.373802] [MDLA][COMM] comm_init done!
Init wrapper sys mutex successful. Pid:203
Info: get MI daemon priority before System Init: [-20]
!!!Enter MI daemon prcoess!! start time =3651
!!!Enter MI daemon flow time=3904!!
...
>> Start TTX service
>> Start  VOC service
Init wrapper sys mutex successful. Pid:232
MI_SYS_Init() without Parameter
[    4.111885] [devnode] devnode_init: start
[    4.117081] [devnode] devnode_init: end
[    4.125587] [devnode] uevent_node: broadcast uevent done
Open MI_OSD kernel module successful
[    4.432662] au32IRWakeHotkey[0] = 0xbf085 
[    4.436887] au32IRWakeHotkey[1] = 0xbf086 
[    4.441031] au32IRWakeHotkey[2] = 0xbf089 
[    4.445190] au32IRWakeHotkey[3] = 0x7f004 
[    4.449307] au32IRWakeHotkey[4] = 0x5f003 
[    4.453448] au32IRWakeHotkey[5] = 0x8f002 
[    4.457610] u1HotkeyCfgNum = 6 
...
!!!MI daemon prcoess start! MI daemon cost time=1613!!!
...
[cpuAudio_createDecoderMonitorThread][314]armAudio_decoderMonitor_ver: 0x1e thread created successfully 
 ...
 [Main]open ok 
 cpuAudio[Info](thread-name:cpu_audio)(pid:232)(tid:333)  
...
[    8.678501] [_MDrv_GFLIPIO_Open,1141][pid:638][name:HwcPrimaryVsync]_devGFLIP.refCnt=0
...
Init wrapper sys mutex successful. Pid:660
MI_SYS_Init() without Parameter
[Utopia][MSOS]: [ERROR][MsOS_CreateMutex][2283]    [MsOS_CreateMutex][2283] Update max number of msos mutex: 256
[utopia info] open: /vendor/etc/utopia.conf
[Utopia][MSOS]: [WARN][MsOS_Init][5909]     Already inited.
...
start to run task
[GAM][ProcessControl.cpp][setState][2641][tid698]dtv_app_mtk:(4 -> 1 )(STOPPED -> STARTING)
task finished
[GAM][ProcessControl.cpp][_thread_wait_process][2800][tid702]dtv_app_mtk start to waitpid pid=701
[GAM][ProcessControl.cpp][setState][2641][tid702]dtv_app_mtk:(1 -> 2 )(STARTING -> STARTED)
[GAM][ERROR][AppManager.cpp][getFocusProcess][1647][tid702][Focus]no focus process
[GAM][ProcessControl.cpp][sendCmd][3016][tid702]:am,dtv_app_mtk,dtv_app_mtk:started=dtv_app_mtk
[GAM][ProcessControl.cpp][sendCmd][3027][tid702]process dtv_app_mtk binder disconnected, not send cmd
[GAM][ProcessControl.cpp][sendCmd][3016][tid702]:am,dtv_app_mtk,:screensaver_hide=dtv_app_mtk
[GAM][ProcessControl.cpp][sendCmd][3027][tid702]process dtv_app_mtk binder disconnected, not send cmd
load mtal 0,handle -1
Init wrapper sys mutex successful. Pid:701
...
_MI_WRAPPER_SYS_SecurityAuthentication[769]: pstInitParams is NULL.
MI_IIC_Init[168]: Error 0x2: failed to ioctl(MI_DEV_IOC_IIC_INIT)
_s32MikAextinFd: 87, aextin init result : 2  
Open MI_OSD kernel module successful
mi_sys_init ret 0
...
[   10.881313] [MI_CEC_SetAttr][2547] Set CEC eARC mode : 3
...
===========================================
[DM] enter dm_reg_nfy_fct: pf_nfy: ef906790
...
<ACFG> [11530] _acfg_app_init_fct start... IDX_MAX:1361
...
<ACFG> [11780] acfg_video_pre_init start... 
<ACFG> [11780] acfg_video_get_data_from_ini start... 
[ACFG][11780]acfg_get_clr_temp_from_ini start... acfg_video_pre_init, 1090
<ACFG> [11780] a_cfg_get_clr_temp_from_ini start... 
[   11.936780] [MI_CEC_SetAttr][2547] Set CEC eARC mode : 3
[   11.942424] [Glue CEC] Notify port:1 5v chg to:1
[   11.947239] [Glue CEC] Notify port:2 5v chg to:1
<ACFG> [11930] a_cfg_get_clr_temp_from_ini end 
[ACFG][11930]acfg_get_clr_temp_from_ini end acfg_video_pre_init, 1093
<ACFG> [11930] basic pq start... 
<ACFG> [11930] a_cfg_get_pq_def_from_ini start... 
<ACFG> [11960] a_cfg_get_pq_def_from_ini end... 
<ACFG> [11960] Advance pq start... 
<ACFG> [11960] a_cfg_get_advence_pq_def_from_ini start... 
<ACFG> [12010] color tuner and 11wb start... 
<ACFG> [12010] a_cfg_get_color_tuner_and_11wb_value_from_ini start... 
<ACFG> [12130] a_cfg_get_color_tuner_and_11wb_value_from_ini 1... 
<ACFG> [12130] a_cfg_get_color_tuner_and_11wb_value_from_ini 2... 
<ACFG> [12160] a_cfg_get_color_tuner_and_11wb_value_from_ini 3... 
<ACFG> [12160] hdmi edid start... 
<ACFG> [12160] disp mode start... 
<ACFG> [12160] acfg_video_get_data_from_ini end... 
<ACFG> [12160] acfg_video_pre_init end 
...
<ACFG> [12160] acfg_audio_pre_init start... 
<ACFG> [12210] acfg_get_sound_mode_value_from_ini start... 
<ACFG> [12260] acfg_get_sound_mode_value_from_ini end 
<ACFG> [12280] acfg_audio_pre_init end... 
MI_SYS_GetConfigData[2623]: MI_SYS_GetConfigData is failed [ERR=3]!
...
[ACFG_MM_TMS][12330][acfg_eep_init:1739][ACFG_EEP][acfg_eep.c:_acfg_eep_pre_init:1431]gui4_acfg_filed_running_code_data_size:50223 
...
<ACFG> [12400] _acfg_app_init_fct end 
{SB_DTMB} 		{dtmb_create_builder_data 1574} _dtmb_retrieve_tuner_attribute(h_rm_tuner 0x101152D, pt_eng_data 0xb9d58964) 
{SB_DTMB} 		{_dtmb_retrieve_tuner_attribute 908} ret 0. tuner attribute:  freq: l 52000000, u 866000000, d 350000; autoQAM 1, autoSR 1; ber_tolerance 175898768 
...
{SB_DTMB} 		{dtmb_free_obj 3460} actually x_tm_free(h_obj 0x1011527 -> 0x0, handle_type 386) ret 0, pv_tag 0xb9d586ec 
{SB_DTMB} 		{_dtmb_free_private_tag 510} pt_msg: type 2, pv_data (nil), flag 0; tm_cond 2, scanIdx 0, seri 0, h_bldr_base 0x1011538, data 0, h_obj 0xD7B23F5C 
...
{SB_CE} 		{dvbc_create_monitor,143} h_root: 0x103151E 
...
{SB_CE} 	{dvbc_delete_builder_data 3123} _dvbc_clean_up(pt_eng_data: 0xb9d58964) 
{SB_CE} 		{dvbc_free_obj 3354} free a root object: h_obj 0x103151E, handle type 386 
{SB_CE} 		{dvbc_free_obj 3379} x_tm_free(h_obj 0x103151E) ret 0, pv_nfy_tag 0xb9d584e4 
{SB_CE} 		{_dvbc_clean_up,627} h_root: 0x103151E -> 0x0 
{SB_DTMB} 		{dtmb_create_builder_data 1574} _dtmb_retrieve_tuner_attribute(h_rm_tuner 0x1051524, pt_eng_data 0xb9d58964) 
{SB_DTMB} [2693] SB_DTMB_MSG_NIT_NFY 
{SB_DTMB} 		{_dtmb_retrieve_tuner_attribute 908} ret 0. tuner attribute:  freq: l 52000000, u 866000000, d 350000; autoQAM 1, autoSR 1; ber_tolerance 175898768 
{SB_DTMB} {dtmb_open_brdcst_root 3675} send SB_DTMB_MSG_BRDCST_ROOT_NFY(2): idx 0, TM_COND_AVAILABLE 2, seri 0, flags 0, data 0 
{SB_DTMB} 		{dtmb_create_monitor 166} dtmb_start_monitor 
{SB_DTMB} CLI: curr cmd: 0  
[MWIF2-CLI]{SB_DTMB} 		{dtmb_load_sdt_actual 4675} return reason: e_cond 1, ui1_scan_idx 0 
[_TunerGet:364] fail, eResult = -258
[util_source][-16][0]
{SB_DTMB} 		{dtmb_start_monitor 282} Exit 
{SB_DTMB} 		{dtmb_set 5795} setDtmbGUILang "eng" 
{SB_DTMB} WARN: 	{dtmb_engine_task 2725} x_sb_get_bldr_data() fail -8 
{SB_DTMB} 		{_dtmb_clean_up 377} Freeing BRDCST type root... 
{SB_DTMB} 		{dtmb_free_obj 3420} try to free a ROOT handle: h_obj 0x1051520, actual handle type 386 
{SB_DTMB} {_dtmb_tm_load_nit_act_nfy 579} send SB_DTMB_MSG_NIT_NFY(6): idx 0, TM_COND_UNAVAILABLE(0), seri 2, flags 0, data 1 
{SB_DTMB} {_dtmb_tm_load_sdt_act_nfy 668} send SB_DTMB_MSG_SDT_NFY(7): idx 0, TM_COND_UNAVAILABLE(0), seri 2, flags 0, data 1 
{SB_DTMB} [2694] SB_DTMB_MSG_SDT_NFY 
{SB_DTMB} 		{dtmb_free_obj 3460} actually x_tm_free(h_obj 0x1051520 -> 0x0, handle_type 386) ret 0, pv_tag 0xb9d5862c 
{SB_DTMB} WARN: 	{dtmb_engine_task 2725} x_sb_get_bldr_data() fail -8 
...
{SB_DTMB} [2339] SB_DTMB_MSG_BRDCST_ROOT_NFY 
{SB_DTMB} 		{_dtmb_free_private_tag 510} pt_msg: type 2, pv_data (nil), flag 0; tm_cond 2, scanIdx 0, seri 0, h_bldr_base 0x1051525, data 0, h_obj 0xD7B23F5C 
{SB_DTMB} 		{_dtmb_free_private_tag 692} do nothing: pt_msg->pv_data (nil), b_free 0, b_timer_free 0 
{SB_DTMB} WARN: 	{dtmb_engine_task 2354} x_sb_get_bldr_data() fail -8 
{SB_DTMB} [2693] SB_DTMB_MSG_NIT_NFY 
{SB_DTMB} WARN: 	{dtmb_engine_task 2725} x_sb_get_bldr_data() fail -8 
...
{SB_DTMB} WARN: 	{dtmb_engine_task 2725} x_sb_get_bldr_data() fail -8 
{SB_CE} {dvbc_create_builder_data 2717} x_svl_open ret 0, b_use_orig 1 
{SB_CE} [3012] _dvbc_retrieve_tuner_attribute(tuner 0x10114E2) 
{SB_CE} 		{_dvbc_retrieve_tuner_attribute 1343} tuner attr: low 48000000, high 859000000, delta 500000, autoQAM 1, autoSR 1 
{SB_CE} 		{dvbc_create_monitor 137} dvbc_open_brdcst_root 
{DT}c_dt_set_tz:131 t_tz_offset=32400
{SB_CE} {dvbc_open_brdcst_root 4596} send SB_DVBC_MSG_BRDCST_ROOT_NFY(2): 0, TM_COND_AVAILABLE 2, seri 0, flags 0 
{SB_CE} 		{dvbc_create_monitor,143} h_root: 0x10114DF 
{SB_CE} 		{dvbc_create_monitor 162} dvbc_start_monitor 
{SB_CE} 	{dvbc_start_monitor 257} country "CHN", operator 0, lang "eng"  
{SB_CE} [3706] SB_DVBC_MSG_BRDCST_ROOT_NFY
[MWIF2-CLI][_TunerGet:364] fail, eResult = -264
...
[ACFG][acfg_get_bootvideo_status:2285] return 0
 [ACFG_MM_TMS][13490][acfg_video_post_init_p2:1619]APP_CFG_RECID_PIC_MODE 
...
[DM] enter dm_reg_nfy_fct: pf_nfy: eed7c6a4
[DM] enter _dm_nfy_new_reg
...
[network] 13.559, x_net_network_ready.2521 >>> can init ...
[network] 13.559, x_net_network_ready.2563 >>> is ready
<NAV_UPDATER> _nav_updater_oad_3rd_partition_status_nfy
<NAV_UPDATER> FS_PARTITION_3RD mounted.
nav_updater_oad_trigger_update
[GAM][ProcessControl.cpp][setState][2641][tid663]dtv_app_mtk:(2 -> 2 )(STARTED -> STARTED)
MTVDO_SetPQ() fail, ret=-1
[ACFG_MM_TMS][13560][_acfg_update_pq_by_picture_mode:6422] ACFG_MSG_PQ_UPDATE_DONE
[ACFG_MM_TMS][13560][acfg_video_post_init_p2:1623]APP_CFG_RECID_PIC_MODE END 
{ACFG} <ACFG> Return fail:acfg_video.c:6741:-8
[MWIF2-VDP]{_VdpUnmuteStatusNotify, 5110} return reason: NULL == _arMwVdp[0].pfEosNfy 
[MWIF2-VDP]{_VdpUnfreezeStatusNotify, 5135} return reason: NULL == _arMwVdp[0].pfEosNfy 
{ACFG} <ACFG> Return fail:acfg_video.c:1625:-5
[QHB] waiting was over for dtv_svc ready -- count 12
...
[ACFG_MM_TMS][13900][acfg_video_post_init_p2:1670]acfg_video_post_init_p1 END 
...
[ISL]Function:a_isl_get_port_id_of_hdmi, line:3138,get hdmi port id,*pi1_port_id=1
 [ISL]Function:a_isl_get_port_id_of_hdmi, line:3138,get hdmi port id,*pi1_port_id=1
 MTVDO_SetPQ() fail, ret=-1
[ACFG_MM_TMS][14100][_acfg_update_pq_by_picture_mode:6422] ACFG_MSG_PQ_UPDATE_DONE
[SCC] x_scc_aud_set_hdphone_detect_nfy:(
		h_aud             = 0x010115C4
		pt_hdph_nfy_info.addr  = 0xeebdcea0 )
...
[ACFG_MM_TMS][14140][acfg_video_post_init_p1:1607]a_cfg_update_all_hdmi_edid_version start
[ISL]Function:a_isl_get_port_id_of_hdmi, line:3138,get hdmi port id,*pi1_port_id=0
 ...
 [ACFG_MM_TMS][14160][acfg_video_post_init_p1:1609]a_cfg_update_all_hdmi_edid_version end
{SB_DTMB} 		{dtmb_create_builder_data 1574} _dtmb_retrieve_tuner_attribute(h_rm_tuner 0x101146B, pt_eng_data 0xb9d58964) 
{SB_DTMB} 		{_dtmb_retrieve_tuner_attribute 908} ret 0. tuner attribute:  freq: l 52000000, u 866000000, d 350000; autoQAM 1, autoSR 1; ber_tolerance 175898768 
{SB_DTMB} {dtmb_open_brdcst_root 3675} send SB_DTMB_MSG_BRDCST_ROOT_NFY(2): idx 0, TM_COND_AVAILABLE 2, seri 0, flags 0, data 0 
{SB_DTMB} 		{dtmb_create_monitor 166} dtmb_start_monitor 
{SB_DTMB} CLI: curr cmd: 0  
...
{SB_DTMB} {_dtmb_tm_load_nit_act_nfy 579} send SB_DTMB_MSG_NIT_NFY(6): idx 0, TM_COND_UNAVAILABLE(0), seri 2, flags 0, data 1 
{SB_DTMB} {_dtmb_tm_load_sdt_act_nfy 668} send SB_DTMB_MSG_SDT_NFY(7): idx 0, TM_COND_UNAVAILABLE(0), seri 2, flags 0, data 1 
{SB_DTMB} 		{dtmb_free_obj 3460} actually x_tm_free(h_obj 0x101146a -> 0x0, handle_type 386) ret 0, pv_tag 0xb9d5865c 
{SB_DTMB} 		{_dtmb_free_private_tag 510} pt_msg: type 2, pv_data (nil), flag 0; tm_cond 2, scanIdx 0, seri 0, h_bldr_base 0x16B1547, data 0, h_obj 0xD7B23F5C 
{SB_DTMB} 		{_dtmb_free_private_tag 692} do nothing: pt_msg->pv_data (nil), b_free 0, b_timer_free 0 
{SB_DTMB} WARN: 	{dtmb_engine_task 2354} x_sb_get_bldr_data() fail -8 
...
{SB_DTMB} 		{dtmb_create_builder_data 1574} _dtmb_retrieve_tuner_attribute(h_rm_tuner 0x1031468, pt_eng_data 0xb9d5eb44) 
{SB_DTMB} 		{_dtmb_retrieve_tuner_attribute 908} ret 0. tuner attribute:  freq: l 52000000, u 866000000, d 350000; autoQAM 1, autoSR 1; ber_tolerance 175898768 
{SB_DTMB} {dtmb_open_brdcst_root 3675} send SB_DTMB_MSG_BRDCST_ROOT_NFY(2): idx 0, TM_COND_AVAILABLE 2, seri 0, flags 0, data 0 
{SB_DTMB} 		{dtmb_create_monitor 166} dtmb_start_monitor 
{SB_DTMB} CLI: curr cmd: 0  
...
{SB_DTMB} 		{dtmb_load_sdt_actual 4675} return reason: e_cond 1, ui1_scan_idx 0 
{SB_DTMB} 		{dtmb_start_monitor 282} Exit 
{SB_DTMB} 		{_dtmb_free_private_tag 510} pt_msg: type 2, pv_data (nil), flag 0; tm_cond 2, scanIdx 0, seri 0, h_bldr_base 0x153147C, data 0, h_obj 0xD7B23F5C 
{SB_DTMB} 		{_dtmb_free_private_tag 692} do nothing: pt_msg->pv_data (nil), b_free 0, b_timer_free 0 
{SB_CE} {dvbc_match_builder_data,3169} match: svl id 2 
func:a_common_setting_cli_init, line:199, i4_ret:0
func:a_common_setting_cli_init, line:203
###### x_svl_reg_list_mode_chg_notify:0xeecd74bc.
###### x_svl_reg_ocl_scan_info_notify:0xeecd75cc.
######[a_mtktvapi_channellist_init][2275] register test nfy: ListModeChg=0xeecd74bc, i4_rc1=0, OclScanInfo=0xeecd75cc, i4_rc2=0 .
...
[MWIF2-MPV]MPV_MwSet(0): MTVDEC_MM_SET_TV_NODATA_TIME_INFO.(16000)
{SM-SCC} [SCC] /home/luohc/work/MTK9666_2/mt9666_sdk_an11_all/mt9666_an11/vendor/mediatek/proprietary_tv/apollo/middleware/open/common/strm_mngr/scc/_scc.c:650 rm_close() fail return -4
_hndlr_a_mtktvapi_eas_reg_callback </home/luohc/work/MTK9666_2/mt9666_sdk_an11_all/mt9666_an11/vendor/mediatek/proprietary_tv/apollo/linux_mts/rpc/broadcast/rpc_handler/mtktvapi/rh_mtktvapi_eas.c: 139>
...
{EWS}Enter _hndlr_a_mtktvapi_ews_reg_msg_callback </home/luohc/work/MTK9666_2/mt9666_sdk_an11_all/mt9666_an11/vendor/mediatek/proprietary_tv/apollo/linux_mts/rpc/broadcast/rpc_handler/mtktvapi/rh_mtktvapi_ews.c: 132> ui4_num_args:2 
{EWS}Fun:a_mtktvapi_ews_reg_msg_callback, Ln:151 successful to register in g_ews_msg_pfun[0]
{EWS}Fun:a_mtktvapi_ews_reg_msg_callback, Ln:153 
{EWS}Enter _hndlr_a_mtktvapi_ews_reg_msg_callback </home/luohc/work/MTK9666_2/mt9666_sdk_an11_all/mt9666_an11/vendor/mediatek/proprietary_tv/apollo/linux_mts/rpc/broadcast/rpc_handler/mtktvapi/rh_mtktvapi_ews.c: 152> Call 
{EWS}Enter _hndlr_a_mtktvapi_ews_reg_msg_callback </home/luohc/work/MTK9666_2/mt9666_sdk_an11_all/mt9666_an11/vendor/mediatek/proprietary_tv/apollo/linux_mts/rpc/broadcast/rpc_handler/mtktvapi/rh_mtktvapi_ews.c: 175> save it in index:0 
MTDRVCUST_OptQuery() fail, [   15.158741] [uart_switch_sysfs_store] Sysfs uartswitch - Write!!!
ret=-1
[ACFG_MM[   15.165326] [uart_switch_sysfs_store] store uart_switch_number 0x03 
_TMS][14910][a_mtktvapi_conf
